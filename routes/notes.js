...
router.post('/', (req, res, next) => {
  ...
  knex 
    ...
    .then(() => {
      ...
      return knex.select('notes.id', 'title', 'content', 'folder_id as folderId', 'folders.name as folderName', 'tags.id as tag_id', 'tags.name as tagName')
        .from('notes')
        .leftJoin('folders', 'notes.folder_id', 'folders.id')
...
router.put('/:id', (req, res, next) => {
  ...
  knex('notes') 
    ...
    .then(() => {
      ...
      return knex.insert(tagsInsert).into('notes.tags');
    })
    .then(() =>  {
